...
<template>
  <div class="relative h-24 w-24 shrink-0 overflow-hidden rounded-lg md:h-auto md:w-full md:aspect-square">
    <img
      :alt="`${artist} - ${title}`"
  ...
  <p class="truncate text-left text-xs text-secondary md:text-center">{{ artist }}</p>
  <span
    :date-time="date.utc"
